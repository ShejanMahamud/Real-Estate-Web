...
<div className='w-[90%] mx-auto grid grid-cols-4 row-auto items-center gap-10 mt-20 text-white'>
    <div className="bg-[url('https://i.ibb.co/Jys06FY/america.webp')] rounded-3xl bg-no-repeat bg-cover h-[350px] bg-center text-center py-5 font-bold uppercase tracking-wider">
    ...
    <div className="bg-[url('https://i.ibb.co/KjLmDvs/spain.webp')] rounded-3xl bg-no-repeat bg-cover h-[350px] bg-center text-center py-5 font-bold text-xl uppercase tracking-wider">
    ...
    <div className="bg-[url('https://i.ibb.co/CnKRbw6/paris.webp')] rounded-3xl bg-no-repeat bg-cover h-[350px] bg-center text-center py-5 font-bold text-xl uppercase tracking-wider">
    ...
    <div className="bg-[url('https://i.ibb.co/D9ZQNvH/london.webp')] rounded-3xl bg-no-repeat bg-cover h-[350px] bg-center text-center py-5 font-bold text-xl uppercase tracking-wider">
