    ...
    <div className="w-[90%] mx-auto my-20 font-dmsans">
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-5">
          <button
            // onClick={seeAllProperties}
            className="text-[#1DAEFF] focus:bg-[#1DAEFF] focus:text-white border border-[#1DAEFF] rounded-full px-5 py-2 font-medium text-sm"
          >
            See All
          </button>
          <button
            // onClick={rentProperties}
            className="text-[#1DAEFF] focus:bg-[#1DAEFF] focus:text-white border border-[#1DAEFF] rounded-full px-5 py-2 font-medium text-sm"
          >
            Rent
          </button>
          <button
            // onClick={sellProperties}
            className="text-[#1DAEFF] focus:bg-[#1DAEFF] focus:text-white border border-[#1DAEFF] rounded-full px-5 py-2 font-medium text-sm"
          >
            Sell
          </button>
      ...
      <div className="w-full grid grid-cols-3 row-auto items-stretch gap-10 mt-20">
        {properties.map((property) => (
          <Estates key={property.id} property={property} />
        ))}
      </div>
    </div>
  );
