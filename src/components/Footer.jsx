  ...
  return (
    <footer className="w-full bg-[#1daeff] px-10 lg:px-40 py-5 flex flex-col gap-8 bg-opacity-5">
	  ...
	  <div className='w-full flex items-center'>
        ...
        <div className="flex gap-3 lg:gap-10 items-center flex-col lg:flex-row w-full justify-end">
          <p className="text-[#494949] font-medium lg:text-base text-sm">
            Ready to explore houses?
          </p>
          <button className="bg-[#1daeff] lg:px-6 px-4 lg:py-3 py-3 text-white text-sm font-extrabold rounded-lg inline-block">
            Get Started
          </button>
        </div>
      </div>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex items-start flex-col gap-3">
              <div className="flex items-center justify-between w-full">
                ...
                />
                <div className="bg-[#1daeff] rounded-full h-6 w-6 flex items-center justify-center">
                  <svg
      ...
      <span className="mt-5 text-center font-bold text-[#494949] tracking-wide">
        © 2024 - All rights reserved By JohuHousing
      </span>
    </footer>
  );
}
